...
SECRET_MAPPINGS=(
  "LINE_CHANNEL_SECRET=CATLENDAR_LINE_CHANNEL_SECRET:latest"
  "LINE_CHANNEL_ACCESS_TOKEN=CATLENDAR_LINE_CHANNEL_ACCESS_TOKEN:latest"
  "GEMINI_API_KEY=GEMINI_API_KEY:latest"
  "GOOGLE_SERVICE_ACCOUNT_JSON=GOOGLE_SERVICE_ACCOUNT_JSON:latest"
  "ENCRYPTION_KEY=ENCRYPTION_KEY:latest"
  "NOTIFY_SECRET=NOTIFY_SECRET:latest"
)
